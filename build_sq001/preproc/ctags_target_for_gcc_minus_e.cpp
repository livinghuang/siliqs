# 1 "/Users/living/code/github/siliqs/sq001s/sq001s.ino"
# 2 "/Users/living/code/github/siliqs/sq001s/sq001s.ino" 2
// Dps310 Opject
bool resendflag = false;
bool deepsleepflag = false;

__attribute__((section(".rtc.data" "." "1"))) int bootCount = 0;
uint64_t chipid;
...
void loop()
{
  ...
  case WIFI_CONNECT_TEST:
  {
    ...
    {
      Serial0.println("wifi connect OK");
    }
  ...
  case LORA_TEST_INIT:
  {
    Serial0.println("LORA_TEST_INIT");
    Serial0.flush();
    lora_init();
  ...
  {
    Serial0.println("LORA_COMMUNICATION_TEST");
    Serial0.flush();
    lora_status_handle();
    delay(1000);
    break;
